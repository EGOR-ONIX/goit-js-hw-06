...
const MIN_BOXES = Number(input.getAttribute("min"));
const MAX_BOXES = Number(input.getAttribute("max"));
const STEP_AMOUNT = Number(input.getAttribute("step"));
...
function createBoxes(amount) {
  ...
  for (let i = 0; i < amount; i += STEP_AMOUNT) {
